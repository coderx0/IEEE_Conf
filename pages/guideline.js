      ...
      <div className="min-h-full bg-gradient-to-r from-white to-indigo-50 ">
        <div className="relative flex-grow items-start justify-start space-x-2 md:flex md:flex-row md:px-8 xl:px-10 ">
          <main className="w-full space-x-6 pt-4 md:flex-grow ">
            ...
            <section class="text-gray-600 body-font  border-rose-500 rounded mt-4 !ml-0">
              <div class=" flex px-5 gap-4 md:flex-row flex-col items-center ml-0">
                <div class=" lg:flex-grow md:w-1/2 flex flex-col md:items-start md:text-left mb-2 md:mb-0 items-center text-center">
                  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Paper Submission
                  </h1>
                  <p class="md:mb-8 leading-relaxed  md:font-semibold md:text-lg">Any interested student/researcher/academician/industry person can
                  ...
                  <h1 class="title-font sm:text-4xl text-3xl mb-4 mt-8 md:mt-2 font-medium text-gray-900 block">Paper Upload
                  </h1>
                  <p class="mb-4 leading-relaxed  md:font-semibold md:text-lg">All papers must be submitted in PDF via Microsoft CMT:</p>
                  <a className='text-rose-500 cursor-pointer inline-block md:text-lg'>https://cmt3.research.microsoft.com/MAC2023</a>
                </div>
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 order-12   ">
                  <Lottie animationData={examsPreparation} loop={true} />
                </div>
              </div>
            </section>
            <section class="text-gray-600 body-font border-rose-500 rounded !ml-0">
              <div class=" flex p-5 gap-4 md:flex-row flex-col items-center">
                <div class="lg:flex-grow  flex flex-col mb-8 md:mb-0 md:items-start md:text-left items-center text-center">
                  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 block">Publication
                  </h1>
                  <p class="mb-4 leading-relaxed  md:font-semibold md:text-lg">All accepted & presented papers of the Conference by duly registered authors, will be submitted to IEEE Xplore Digital Library for Possible Publication.</p>
                </div>
