        ...
        <div className="min-h-full bg-gradient-to-r from-white to-indigo-50">
          <div className="relative flex-grow items-start justify-start space-x-2 px-4 md:flex md:flex-row md:px-8 xl:px-10">
            <main className="w-full space-x-6 pt-4 md:flex-grow">
              ...
              <RightImageCard title="Emerging Technologies and Systems" description="Machine Learning and AI Technologies, VLSI for Communication, Medical Image Processing, Magnetic Induction (MI) based Communications, MIMO Techniques, Underwater Wireless Communication, Underwater Sensors & Modern Sensor System, IOT Technologies, Energy Harvesting, Green Communication, Molecular Communication." image="/emergingTech.webp" />
            </main>
          </div>
